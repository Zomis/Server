...
@FourChar(value = 'MOVE', incomingStr = { mess -> new GameMoveXY(gameId: mess[1] as int,
    x: mess[2] as int, y: mess[3] as int, type: mess.length > 4 ? mess[4] : '')}, outgoingStr = { "$gameId $x $y $type" })
